...
int main(){
	string a,b;
	cin>>a>>b;
	string soundexmap_a = phonetic(a);
	string soundexmap_b = phonetic(b);
	cout<<"Soundex Map of "<<a<<" : "<<soundexmap_a<<endl;
	cout<<"Soundex Map of "<<b<<" : "<<soundexmap_b<<endl;
	if(soundexmap_a==soundexmap_b){
		cout<<"Both words phonetically sound same";
	}
	else{
		cout<<"Both words phonetically sound different";
	}
	return 0;
}
